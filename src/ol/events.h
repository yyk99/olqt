...
typedef void EventsListenerFunctionType(void *, void *);
...
struct EventsKey {
    ...
    void *bind_to;
    bool callOnce;
    EventsListenerFunctionType *listener;
    ol::events::EventType::enum_t type;

    EventsKey() : bind_to(), callOnce(false), listener(), type()
    {}

    EventsKey(void *b, bool once, EventsListenerFunctionType *l, ol::events::EventType::enum_t t)
        : bind_to(b), callOnce(once), listener(l), type(t)
    {}
};
