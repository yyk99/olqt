...
#include <ol/typedefs.h> /* extent */
#include <ol/source/State.h>
...
public:
    struct Options {
        ...
        std::string logo;
        std::shared_ptr<ol::proj::Projection> projection;
        ol::optional<ol::source::State::enum_t> state;
    };
