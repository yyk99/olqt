...
class TileGridF : public ::testing::Test {
public:
    ol::resolutions_t resolutions;
    ol::Coordinate origin;
    ol::Size tileSize;

protected:
    virtual void SetUp() override
    {
        resolutions.assign({ 1000, 500, 250, 100 });
        origin.assign({ 0, 0 });
        tileSize.assign({ 100, 100 });
    }
};

TEST_F(TileGridF, create_valid)
{
    //
    ...
    EXPECT_NO_THROW(ol::tilegrid::TileGrid(resolutions, options));
}

TEST_F(TileGridF, create_with_duplicate_resolutions)
{
...
//
    ...
    EXPECT_THROW(ol::tilegrid::TileGrid(ol::resolutions_t({100, 50, 50, 25, 10}), options), std::runtime_error);
}

TEST_F(TileGridF, create_with_out_of_order_resolutions)
{
...
//  });
    ...
    EXPECT_THROW(ol::tilegrid::TileGrid(ol::resolutions_t({ 100, 25, 50, 10 }), options), std::runtime_error);
}

TEST_F(TileGridF, create_with_multiple_origins)
{
...
//  });
    ...
    EXPECT_NO_THROW(ol::tilegrid::TileGrid(ol::resolutions_t({ 100, 50, 25, 10 }), options));
}

TEST_F(TileGridF, create_with_both_origin_and_multiple_origins)
{
//
...
//  });
    ...
    EXPECT_THROW(ol::tilegrid::TileGrid(ol::resolutions_t({ 100, 50, 25, 10 }), options), std::runtime_error);
}
//

TEST_F(TileGridF, create_with_too_few_origins)
{
...
//
TEST_F(TileGridF, create_with_too_many_origins)
{
...
//
TEST_F(TileGridF, create_with_multiple_tileSizes)
{
...
TEST_F(TileGridF, create_with_both_tileSize_and_multiple_tileSizes)
{
    ...
    EXPECT_THROW(ol::tilegrid::TileGrid(resolutions, options), std::runtime_error);
}

TEST_F(TileGridF, create_with_too_few_tileSizes)
{
//
...
TEST_F(TileGridF, create_with_too_many_tileSizes)
{
...
TEST_F(TileGridF, create_with_origin)
{
...
//    });
    EXPECT_EQ(10, tileGrid.getOrigin().at(0));
    EXPECT_EQ(40, tileGrid.getOrigin().at(1));
//
...
TEST_F(TileGridF, createForExtent)
{
...
TEST_F(TileGridF, getForProjection)
{
...
TEST_F(TileGridF, getTileCoordChildTileRange)
{
...
//
TEST_F(TileGridF, forEachTileCoordParentTileRange)
{
...
TEST_F(TileGridF, getResolution) {
...
//
TEST_F(TileGridF, getTileCoordFromCoordAndZ)
{
...
TEST_F(TileGridF, getTileRangeForExtentAndZ)
{
...
TEST_F(TileGridF, forEachTileCoord)
{
...
TEST_F(TileGridF, forEachTileCoordParentTileRange2)
{
	//  describe('forEachTileCoordParentTileRange', function() {
	//    it('iterates as expected', function() {
	//      var tileGrid = new ol.tilegrid.TileGrid({
